...
%token ABRE_CHAVE FECHA_CHAVE ABRE_PAREN FECHA_PAREN VIRGULA NOVA_LINHA IGUAL OR AND COMPARA_IGUAL MAIOR MENOR MAIS MENOS MULT DIV NOT
...
statement:
    ABRE_PAREN ID VIRGULA NUM FECHA_PAREN IGUAL ABRE_PAREN expressao VIRGULA DATA FECHA_PAREN
